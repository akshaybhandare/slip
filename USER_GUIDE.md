...
* **🔄 Sort & Group Controls**: Use the feed toolbar right above your stream to switch between **Newest First**, **Oldest First**, **Title (A-Z)**, or **Group by Type** to view collapsible sections for Articles, Notes, Documents, Images, Websites, and Videos with live counters. Customize your default view anytime under **Settings ➔ Appearance ➔ Feed & View Preferences**.
